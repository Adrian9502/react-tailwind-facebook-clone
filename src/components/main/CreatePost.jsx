export default function CreatePost() {
  return (
    <section className="bg-zinc-800 mb-3 flex flex-col px-4 pt-3 pb-2 rounded-lg w-full">
      ...
      <div className="grid grid-cols-3 font-semibold text-zinc-400 pb-1 text-sm">
        <div className="flex cursor-pointer items-center transition justify-center gap-2 hover:bg-zinc-700 p-2  rounded-lg">
          <img
        ...
        <div className="flex items-center justify-center transition gap-2 cursor-pointer hover:bg-zinc-700 p-2  rounded-lg">
          <img
